...
function LoginForm() {
  ...
  const [errorMsg, setErrorMsg] = useState(
    error === "AccessDenied" ? "僅限 @tzuchi.org.tw 帳號登入" : ""
  );
  ...
  const handleCredentials = async (e: React.FormEvent) => {
    ...
    if (!email.endsWith("@tzuchi.org.tw")) {
      ...
      <div className="w-full max-w-[400px]">
        ...
        <div className="bg-white rounded-xl p-8 shadow-sm border border-[#E5E0D8]">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border border-[#E5E0D8] rounded-lg hover:bg-[#FAF8F5] transition-colors text-[14px] text-[#1A1816] font-medium"
          >
          ...
          <form onSubmit={handleCredentials} className="flex flex-col gap-4">
            <div>
              ...
              <input
                ...
                placeholder="name@tzuchi.org.tw"
